...
public class PictureActivity extends AppCompatActivity {
    ...
    private static final String CLOUD_VISION_API_KEY = GoogleConsts.CLOUD_VISION_API_KEY;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        if((i.getStringExtra("selectedOldPic")).toString().trim().equals("NONE")) {
            ...
            textView.setText(i.getStringExtra("selectedOldPic"));
        }
    }

    public void startGalleryChooser() {
        if (com.example.faizan.eyespeak.PermissionUtils.requestPermission(this, GALLERY_PERMISSIONS_REQUEST, Manifest.permission.READ_EXTERNAL_STORAGE)) {
    ...
    private void callCloudVision(final Bitmap bitmap) throws IOException {
        ...
        new AsyncTask<Object, Void, String>() {
            ...
            protected void onPostExecute(String result) {
                int secondIndex = result.indexOf(':', result.indexOf(':')+1)+2;
                result = result.substring(secondIndex);
                result = (result.split("\n"))[0];
                Log.d("Here", result);
                textView.setText(result);
                try {
                    oldPicturesDBManager.insertData(
